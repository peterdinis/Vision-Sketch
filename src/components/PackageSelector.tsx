        ...
        {PACKAGES.map((pkg) => {
          ...
          return (
            <div
              ...
              className={cn(
                "flex items-center gap-3 p-3 rounded-xl border transition-all duration-200 text-left cursor-pointer group",
                isSelected 
            ...
            >
              ...
              />
              <Icon className={cn("w-5 h-5 transition-transform group-hover:scale-110", isSelected ? "text-primary" : "text-muted-foreground")} />
